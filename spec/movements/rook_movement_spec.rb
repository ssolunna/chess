...
describe RookMovement do
  ...
  describe '#from' do
    ...
    context 'when current square is a8' do
      it 'returns an array of moves: a7, a6, a5, a4, a3, a2, a1, b8, c8, d8,
      e8, f8, g8, h8' do
        current_square = 'a8'
    ...
    context 'when current square is h1' do
      it 'returns an array of moves: h2, h3, h4, h5, h6, h7, h8, g1, f1, e1,
      d1, c1, b1, a1' do
        current_square = 'h1'
    ...
    context 'when current square is d4' do
      it 'returns an array of moves: d5, d6, d7, d8, d3, d2, d1, c4, b4, a4,
      e4, f4, g4, h4' do
        current_square = 'd4'
    ...
    context 'when current square is h5' do
      it 'returns an array of moves: h6, h7, h8, h4, h3, h2, h1, g5, f5, e5,
      d5, c5, b5, a5' do
        current_square = 'h5'
    ...
    context 'when current square is a7' do
      it 'returns an array of moves: a8, a6, a5, a4, a3, a2, a1, b7, c7, d7,
      e7, f7, g7, h7' do
        current_square = 'a7'
