    ...
    context 'with white pawns' do
      ...
      context 'when black pawn does double steps to the left' do
        context 'if black pawn was the last piece moved by its player' do
          it 'returns an array including the passed over square on the left' do
            current_square = 'e5'
            board = { "d5" => instance_double('Pawn', color: opponent_color, moves_log: %w[d7 d5], current_square: 'd5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if black made another move after its pawn' do
          it 'returns an array not including the passed over square on the left' do
            current_square = 'e5'
            board = { "d5" => instance_double('Pawn', color: opponent_color, moves_log: %w[d7 d5], current_square: 'd5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
            square_passed_over = 'd6'
      ...
      context 'when black pawn does double steps to the right' do
        context 'if black pawn was the last piece moved its player' do
          it 'returns an array including the passed over square on the right' do
            current_square = 'f5'
            board = { "g5" => instance_double('Pawn', color: opponent_color, moves_log: %w[g7 g5], current_square: 'g5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if black made another move after its pawn' do
          it 'returns an array not including the passed over square on the left' do
            current_square = 'f5'
            board = { "g5" => instance_double('Pawn', color: opponent_color, moves_log: %w[g7 g5], current_square: 'g5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
            square_passed_over = 'g6'
      ...
      context 'when black pawns made double steps to the right and left' do
        context 'if black pawn on the right was the last piece moved by its player' do
          it 'returns an array including the passed over square on the right' do
            current_square = 'b5'
            board = { "a5" => instance_double('Pawn', color: opponent_color, moves_log: %w[a7 a5], current_square: 'a5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)),
                      "c5" => instance_double('Pawn', color: opponent_color, moves_log: %w[c7 c5], current_square: 'c5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if black pawn on the left was the last piece moved by its player' do
          it 'returns an array including the passed over square on the left' do
            current_square = 'd5'
            board = { "c5" => instance_double('Pawn', color: opponent_color, moves_log: %w[a7 a5], current_square: 'a5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)),
                      "e5" => instance_double('Pawn', color: opponent_color, moves_log: %w[c7 c5], current_square: 'c5', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
    ...
    context 'with black pawns' do
      ...
      context 'when white pawn does double steps to the left' do
        context 'if white pawn was the last piece moved by its player' do
          it 'returns an array including the passed over square on the left' do
            current_square = 'e4'
            board = { "d4" => instance_double('Pawn', color: opponent_color, moves_log: %w[d2 d4], current_square: 'd4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if white made another move after its pawn' do
          it 'returns an array not including the passed over square on the left' do
            current_square = 'e4'
            board = { "d4" => instance_double('Pawn', color: opponent_color, moves_log: %w[d2 d4], current_square: 'd4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
            square_passed_over = 'd3'
      ...
      context 'when white pawn does double steps to the right' do
        context 'if white pawn was the last piece moved its player' do
          it 'returns an array including the passed over square on the right' do
            current_square = 'f4'
            board = { "g4" => instance_double('Pawn', color: opponent_color, moves_log: %w[g2 g4], current_square: 'g4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if white made another move after its pawn' do
          it 'returns an array not including the passed over square on the left' do
            current_square = 'f4'
            board = { "g4" => instance_double('Pawn', color: opponent_color, moves_log: %w[g2 g4], current_square: 'g4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
            square_passed_over = 'g3'
      ...
      context 'when white pawns made double steps to the right and left' do
        context 'if white pawn on the right was the last piece moved by its player' do
          it 'returns an array including the passed over square on the right' do
            current_square = 'b4'
            board = { "a4" => instance_double('Pawn', color: opponent_color, moves_log: %w[a2 a4], current_square: 'a4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)),
                      "c4" => instance_double('Pawn', color: opponent_color, moves_log: %w[c2 c4], current_square: 'c4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)) }
        ...
        context 'if white pawn on the left was the last piece moved by its player' do
          it 'returns an array including the passed over square on the left' do
            current_square = 'd4'
            board = { "c4" => instance_double('Pawn', color: opponent_color, moves_log: %w[a2 a4], current_square: 'a4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => true)),
                      "e4" => instance_double('Pawn', color: opponent_color, moves_log: %w[c2 c4], current_square: 'c4', :is_a? => true, player: instance_double('Player', :last_touched_piece? => false)) }
